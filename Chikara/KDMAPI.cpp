...
//  int(__cdecl* SendCustomEvent)(unsigned long eventtype, unsigned long chan, unsigned long param);
//  int(__cdecl* TerminateKDMAPIStream)();
//  void(__cdecl* ResetKDMAPIStream)();
//
//  void Init() 
//  {
...
//    SendCustomEvent = (BOOL(*)(DWORD, DWORD, DWORD))GetProcAddress(dll_handle, "SendCustomEvent");
//    TerminateKDMAPIStream = (BOOL(*)())GetProcAddress(dll_handle, "TerminateKDMAPIStream");
//    ResetKDMAPIStream = (void(*)())GetProcAddress(dll_handle, "ResetKDMAPIStream");
//  }
//
//  void Destroy() {
